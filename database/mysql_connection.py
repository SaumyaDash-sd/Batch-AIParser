...
# insert_query = [
#             {
#                 "query": f"INSERT table_name SET status = %s, html_component = %s, updated_at = %s WHERE id = %s",
...
# update_query = [
#             {
#                 "query": f"UPDATE table_name SET status = %s, html_component = %s, updated_at = %s WHERE id = %s",
#                 "data": ("value_1", "value_2", "value_3", "value_4"),
#             }
#         ]
# result = connection.update(update_query)
